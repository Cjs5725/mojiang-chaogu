"""earnings CLI 入口：mojiang-earnings。

注册方式（在 pyproject.toml 里）：
    [project.scripts]
    mojiang-earnings = "mojiang_chaogu.earnings.cli:main_earnings"

用法示例：
    # 拉取某批股票的 actual 业绩
    mojiang-earnings pull --codes 603662,603986 --period "H1 2026"

    # 批量比对 actual vs predicted
    mojiang-earnings score --period "H1 2026"

    # 列出未来 7 天的披露日历
    mojiang-earnings watch --days 7

    # 看 period 的 verdict 分布
    mojiang-earnings summary --period "H1 2026"
"""
...
from mojiang_chaogu.db_paths import REFERENCE_DB
from mojiang_chaogu.earnings import (
    EarningsService,
    EarningsStore,
    EfinanceEarningsAdapter,
    MockEarningsAdapter,
)
from mojiang_chaogu.earnings.types import VERDICT_LABEL, EarningsVerdict
