...
from mojiang_chaogu.db_paths import register_sqlite3_adapters
from mojiang_chaogu.earnings.schema import SCHEMA_SQL
...
class EarningsStore:
    ...
    def _row_to_actual(row: sqlite3.Row) -> EarningsActual:
        ...
        from mojiang_chaogu.earnings.types import EarningsSource
