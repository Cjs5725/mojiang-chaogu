...
- ``pairing`` — api_token set + a pairing code digest provided; browsers
  ...
  eliminating copy/paste of MOJIANG_API_TOKEN. Bearer remains fully compatible.
...
SESSION_COOKIE_NAME = "mojiang-session"

_PAIRING_TTL_SECONDS = 10 * 60
_PAIRING_MAX_FAILURES = 5
_SESSION_TTL_SECONDS = 30 * 24 * 60 * 60  # 30 days

_PAIRING_CONTEXT = "mojiang-pairing-v1"
_SESSION_CONTEXT = "mojiang-session-v1"
