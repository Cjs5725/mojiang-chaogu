...
from mojiang_chaogu.backtest.engine import BacktestEngine
...
from mojiang_chaogu.portfolio import PortfolioStore
from mojiang_chaogu.semicon import SemiconStore
from mojiang_chaogu.signals import Alerter, SignalStore
...
def get_portfolio_db() -> Path:
    ...
    mojiang-web --db 的进程级覆盖见 set_portfolio_db_override。
    """
...
# 进程级 portfolio.db 覆盖（mojiang-web --db）。仍然全局单值——
