...
from mojiang_chaogu.monitor import Monitor, Snapshot
from mojiang_chaogu.push import SignalNotifier
...
class BackgroundService:
    ...
    async def add_quote_subscriber(self, ws: WebSocket) -> None:
        ...
        if self._latest_snapshot is not None:
            from mojiang_chaogu.web.routes.ws import push_snapshot
    ...
    async def _broadcast_signals(self, signals: list[Any]) -> None:
        from mojiang_chaogu.web.routes.ws import push_signals
