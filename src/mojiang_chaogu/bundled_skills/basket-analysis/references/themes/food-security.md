...
- **size**: 35
- **source**: `mojiang food-security` (自建 CLI, 跟 `mojiang semicon` 平行)
...
- **seed**: `mojiang food-security seed`
- **stats**: `mojiang food-security stats`
- **list**: `mojiang food-security list --chain 上游`
