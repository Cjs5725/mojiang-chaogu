...
basket:
  ...
  source_options:
    - "mojiang <cli-name>"              #   (a) 用 mojiang CLI (推荐, 自动有 seed/list/stats 子命令)
    - "mojiang watchlist <group_name>"  #   (b) 用 watchlist 的某个 group
...
python3 scripts/analyze.py \
  ...
  --out /workspace/mojiang-deliverables/innovative-drugs/2026-08-19/run1/ \
